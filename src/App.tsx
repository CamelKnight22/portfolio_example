      ...
      <div className=" bg-teal-50 px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className=" min-h-screen ">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="font-extrabold text-xl">camelCaseDeveloper</h1>
          ...
          <div className="text-center p-10 py-10 flex flex-col gap-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1 ">
              ...
              <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
                Blending code with creativity, welcome to the digital playground
                of a full-stack developer and dynamic content creator. Dive in
                to explore a fusion of technological prowess and imaginative
                storytelling.
              </p>
            ...
            <div className="basis-1/3 flex-1 ">
              <div className="mx-auto rounded-full shadow-2xl w-80 h-80 overflow-hidden mt-5 md:h-96 md:w-96">
        ...
        <section>
          <div>
            ...
            <p className=" text-center p-10 py-10 text-md  leading-8 text-gray-800 dark:text-gray-200">
              In the intricate web of the digital universe, I've carved out a
              niche that harmoniously blends the logical with the creative. My
              journey as a full-stack developer, content creator, and game
              developer has equipped me with a diverse skillset, making me adept
              at turning abstract ideas into tangible realities. Let's embark on
              a journey through the three pillars of my expertise.
            </p>
          </div>
          <div className="lg:flex gap-10">
            <div className="flex flex-col items-center text-center shadow-lg p-10 rounded-xl my-10  dark:bg-gradient-to-r from-slate-300 text- to-slate-500 flex-1">
              ...
              <h3 className="text-lg font-bold pt-8 pb-2  ">Developer</h3>
              <p className="py-2">
                As a full-stack developer, I've embraced the challenges and
                rewards that come from crafting seamless digital experiences.
                Every line of code I write is a testament to my commitment to
                functionality and aesthetics alike. Here are the tools I harness
            ...
            <div className="flex flex-col items-center text-center shadow-lg p-10 rounded-xl my-10 dark:bg-gradient-to-r from-slate-300 text- to-slate-500 flex-1">
              ...
              <p className="py-2">
                Storytelling is an art, and with the right medium, its impact
                can be profound. Through content creation, I fuse emotion,
                narrative, and visuals to connect with diverse audiences. Here
                are the tools that empower me to weave stories:
              </p>
              <h4 className="py-4 font-medium text-teal-600"> Stack</h4>
            ...
            <div className="flex flex-col items-center text-center shadow-lg p-10 rounded-xl my-10 dark:bg-gradient-to-r from-slate-300 text- to-slate-500 flex-1">
              ...
              <p className="py-2">
                The world of gaming and 3D modeling is a playground of limitless
                possibilities. With a blend of imagination and technical
                prowess, I create immersive worlds and characters that captivate
                and inspire. My toolkit in this realm includes:
              </p>
              <h4 className="py-4 font-medium text-teal-600"> Stack</h4>
        ...
        <section className="py-10">
          <div>
            ...
            <p className="text-center p-10 py-10 text-md leading-8 text-gray-800 dark:text-gray-200">
              Every project I undertake is a step in my ongoing journey of
              exploration and growth. Thank you for joining me on this
              adventure.
            </p>
          </div>
